...
// 
// It will likely not work right away because some of the definitions conflict with that of other files... Exclude all other files src from project, then build. 
//
